...
const log = (p: any) => p.then(console.log);
const logs = (ps: any[]) => ps.forEach(log);
...
var cookie = readFileSync("taobao/cookie.txt", "utf8");
...
var headers = {
  ...
  "User-Agent": ua,
  Referer:
    "https://uland.taobao.com/coupon/edetail?e=AT6wgpt%2FNyg8Clx5mXPEKr69i0zMxe4jWMvhSb44Edmw85BoRshFq6wBX0XfmyARkQxSGIV4OztoyNpUkNh%2FxTo8fdqvbLi0Wv9OAj9evKBNnqF6eT4r4edth9k8bqqSHKTgBzHkoM7XTQC0vfau6E%2F9Zk7cDx8UPY2GSU4OeGeLQYvlxhc7DpC%2FLp5MQgK2&traceId=0b83b93f15618668109515071e&union_lens=lensId:0b832c69_0c36_16ba684365e_e66b&xId=lUv9OQtZ7xaQLLauthhyH2uTzFHaG7lOlvachHQC0zwB9jOfwmj1Kb3VGpRSHZZP7KnBPBJH3CWmiAbVOigTbU&ut_sk=1.utdid_null_1561866811299.TaoPassword-Outside.taoketop&sp_tk=77+lbUg2RFlnaXZUYjDvv6U="
};
var url =
  "https://uland.taobao.com/coupon/edetail?e=AT6wgpt%2FNyg8Clx5mXPEKr69i0zMxe4jWMvhSb44Edmw85BoRshFq6wBX0XfmyARkQxSGIV4OztoyNpUkNh%2FxTo8fdqvbLi0Wv9OAj9evKBNnqF6eT4r4edth9k8bqqSHKTgBzHkoM7XTQC0vfau6E%2F9Zk7cDx8UPY2GSU4OeGeLQYvlxhc7DpC%2FLp5MQgK2&traceId=0b83b93f15618668109515071e&union_lens=lensId:0b832c69_0c36_16ba684365e_e66b&xId=lUv9OQtZ7xaQLLauthhyH2uTzFHaG7lOlvachHQC0zwB9jOfwmj1Kb3VGpRSHZZP7KnBPBJH3CWmiAbVOigTbU&ut_sk=1.utdid_null_1561866811299.TaoPassword-Outside.taoketop&sp_tk=77+lbUg2RFlnaXZUYjDvv6U=";
...
function getSign(data: any, t: number) {
...
function getCoupon() {
  ...
  var data = JSON.stringify({
    variableMap: JSON.stringify({
      couponKey:
        "pBpSzk94Rj8EYV3zO%2FedTAX1WRz%2FXSEEro9wwDWrPl%2B6bWObfc7JKhk%2B%2FAHCsa496oB7Q0mfsyMPJ5yh1BLqb%2BtoCK4RJow0fcUexJYMu7zn4ZPwEKSBgKJ7%2BkHL3AEW",
      af: "1",
...
async function getMobileCartInfo() {
  ...
  var text: string = await request.get(
...
function h(a: string) {
  ...
  function d(a: number, b: number, c: number) {
    return (a & b) | (~a & c);
  }
  function e(a: number, b: number, c: number) {
    return (a & c) | (b & ~c);
  }
