...
async function directBuy(url) {
    ...
    var { defaultModel: { deliveryDO: { areaId } } } = JSON.parse(/\((.*)\)/.exec(detail_text)[1]);
    Object.assign(form, {
        destination: areaId
    });
    var qs_data = {
...
directBuy("https://detail.tmall.com/item.htm?spm=a220l.1.0.0.76577f33XEjg8i&id=594102186015&skuId=4323285303573");
