...
request
    .get("https://cart.taobao.com/cart.htm?spm=a21bo.2017.1997525049.1.5af911d95m9pSa&from=mini&ad_id=&am_id=&cm_id=&pm_id=1501036000a02c5c3739", {
    ...
    .then(body => {
    fs_extra_1.writeFile("a.html", body);
});
